---
title: 'Vulnhub 打靶记录:W1r3s 1.0.1'
published: 2026-05-05
description: 'VulnHub 上的 W1r3s 1.0.1，难度 Easy。通过 FTP 匿名访问获取员工列表，利用 Cuppa CMS 文件包含漏洞读取敏感文件，破解哈希获得凭证立足系统，最后通过 sudo 提权到 root。'
image: './img/header/W1r3s1.0.1.png'
tags: ["VulnHub", "Easy", "Linux", "文件包含", "密码破解", "sudo提权"]
category: '靶机渗透'
draft: false
lang: ''
---
